...
class pkg_extrawatchInstallerScript {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    if ($action == "install") {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        $code .= "</ul></div>";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        $code .= "<iframe src=\"http://www.extrawatch.com/track/extrawatch/2.3/install/?time=".time()."&license=PRO&domain=$domain&version=2.3.2425&ip=$ip&env=ExtraWatchJoomlaEnv\" width=\"1px\" height=\"1px\" frameborder=\"0\" style='max-width:0px;'></iframe>";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
