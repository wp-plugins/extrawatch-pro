...
DEFINE('_EW_VISITS_CAME_FROM', "PriÅ¡el iz");
DEFINE('_EW_VISITS_MODULE_NOT_PUBLISHED', "VaÅ¡ ExtraWatch modul ni objavljen! Nova statistika se ne beleÅ¾i. ÄŒe ga Å¾elite objaviti, pojdite v sekcijo Moduli in ga objavite na vseh straneh.");
DEFINE('_EW_VISITS_PANE_LOADING', "Nalagam obiske...");

// Right stats window.
DEFINE('_EW_STATS_TITLE', "Statistika tega tedna");
DEFINE('_EW_STATS_WEEK', "Teden Å¡t.");
DEFINE('_EW_STATS_THIS_WEEK', "ta teden");
DEFINE('_EW_STATS_UNIQUE', "obiski");
DEFINE('_EW_STATS_LOADS', "osveÅ¾itve");
DEFINE('_EW_STATS_HITS', "zadetki");
DEFINE('_EW_STATS_TODAY', "danes");
DEFINE('_EW_STATS_FOR', "za");
DEFINE('_EW_STATS_ALL_TIME', "Skupaj");
DEFINE('_EW_STATS_EXPAND', "razÅ¡iri");
DEFINE('_EW_STATS_COLLAPSE', "sesedi");
DEFINE('_EW_STATS_URI', "strani");
DEFINE('_EW_STATS_COUNTRY', "drÅ¾av");
...
DEFINE('_EW_STATS_KEYWORDS', "kljuÄ?nih besed");
...
DEFINE('_EW_STATS_LOADING_WAIT', "nalagam... prosimo poÄ?akajte");
DEFINE('_EW_STATS_IP_BLOCKING_TITLE', "Blokiranje IP naslova");
DEFINE('_EW_STATS_IP_BLOCKING_ENTER', "RoÄ?no vnesi IP naslov");
DEFINE('_EW_STATS_IP_BLOCKING_MANUALLY', "Vnesite IP naslov, ki ga Å¾elite blokirati. (Ä?e Å¾elite blokirati skupino IP naslovo uporabite ta zgled: 217.* ali 217.242.*)");
DEFINE('_EW_STATS_IP_BLOCKING_TOGGLE', "Ali res Å¾elite blokirati ");
...
DEFINE('_EW_SETTINGS_HISTORY_PERFORMANCE', "Zgodovina in izvrÅ¡evanje");
...
DEFINE('_EW_SETTINGS_RESET_CONFIRM', "Ali Å¾elite ponastaviti vso statistiko in podatke obiskovalcev?");
...
DEFINE('_EW_SUCCESS', "Operacija je bila uspeÅ¡na");
DEFINE('_EW_RESET_SUCCESS', "Statistika in podatki obiskovalcev uspeÅ¡no izbrisani");
...
DEFINE('_EW_AJAX_PERMISSION_DENIED_1', "AJAX dostop zavrnjen: Prosimo prepriÄ?ajte, da je vneÅ¡ena prava domena v configuration.php - ");
DEFINE('_EW_AJAX_PERMISSION_DENIED_2', "MogoÄ?e ste pozabili www. pred vaÅ¡o domeno. Javascript poskuÅ¡a dostopati do ");
DEFINE('_EW_AJAX_PERMISSION_DENIED_3', "iz");
DEFINE('_EW_AJAX_PERMISSION_DENIED_4', "zato misli, da je to druga domena.");

// Header.
DEFINE('_EW_HEADER_DOWNLOAD', "Zadnjo razliÄ?ico dodatka lahko dobite na");
DEFINE('_EW_HEADER_CAST_YOUR', "Podaj svoj");
DEFINE('_EW_HEADER_VOTE', "glas");

// Tooltips.
DEFINE('_EW_TOOLTIP_CLICK', "Kliknite za prikaz pomoÄ?i");
DEFINE('_EW_TOOLTIP_MOUSE_OVER', "Zapeljite miÅ¡ko Ä?ez za prikaz pomoÄ?i");
DEFINE('_EW_TOOLTIP_YESTERDAY_INCREASE', "yesterday&apos;s increase");
DEFINE('_EW_TOOLTIP_HELP', "Odpre zunanjo pomoÄ? za");
DEFINE('_EW_TOOLTIP_WINDOW_CLOSE', "Zapri to okno");
DEFINE('_EW_TOOLTIP_PRINT', "Natisni");

// Goals.
DEFINE('_EW_GOALS_INSERT', "Vnesi nov cilj");
DEFINE('_EW_GOALS_UPDATE', "Posodobi cilj Å¡tevilka ");
DEFINE('_EW_GOALS_ACTION', "Dejanja");
DEFINE('_EW_GOALS_TITLE', "Nov cilj");
DEFINE('_EW_GOALS_NEW', "Nov cilj");
DEFINE('_EW_GOALS_RELOAD', "Ponovno naloÅ¾i");
DEFINE('_EW_GOALS_ADVANCED', "Napredno");
DEFINE('_EW_GOALS_NAME', "Ime");
DEFINE('_EW_GOALS_ID', "Å tevilka cilja");
...
DEFINE('_EW_GOALS_CAME_FROM_CONDITION', "Pogoj za izhajaliÅ¡Ä?e");
DEFINE('_EW_GOALS_BLOCK', "Blokiraj");
DEFINE('_EW_GOALS_REDIRECT', "Preusmeri na URL naslov");
DEFINE('_EW_GOALS_HITS', "Zadetki");
DEFINE('_EW_GOALS_ENABLED', "OmogoÄ?eno");
DEFINE('_EW_GOALS_EDIT', "Uredi");
DEFINE('_EW_GOALS_DELETE', "IzbriÅ¡i");
DEFINE('_EW_GOALS_DELETE_CONFIRM', "Izgubili boste vse podatke tega cilja. Ali res Å¾elite izbrisati cilj Å¡tevilka ");

// Frontend.
DEFINE('_EW_FRONTEND_COUNTRIES', "DrÅ¾ave");
DEFINE('_EW_FRONTEND_VISITORS', "Obiskovalci");
DEFINE('_EW_FRONTEND_TODAY', "Danes");
DEFINE('_EW_FRONTEND_YESTERDAY', "VÄ?eraj");
DEFINE('_EW_FRONTEND_THIS_WEEK', "Ta teden");
DEFINE('_EW_FRONTEND_LAST_WEEK', "PrejÅ¡nji teden");
DEFINE('_EW_FRONTEND_THIS_MONTH', "Ta mesec");
DEFINE('_EW_FRONTEND_LAST_MONTH', "PrejÅ¡nji mesec");
DEFINE('_EW_FRONTEND_TOTAL', "Skupaj");

// Settings description - quite long.
DEFINE('_EW_DESC_DEBUG', "ExtraWatch je nastavljena na razhroÅ¡Ä?evanje. Tako lahko odkrijete izvor napake. Za izklop spremenite vrednost EXTRAWATCH_DEBUG v /components/com_extrawatch/config.php iz 1 v 0.");
DEFINE('_EW_DESC_STATS_MAX_ROWS', "NajveÄ?je prikazano Å¡tevilo vrstic, ko je statistika razÅ¡irjena.");
DEFINE('_EW_DESC_STATS_IP_HITS', "Vsi IP naslovi, ki imajo manj zadetkov kot prejÅ¡nji dan bodo izbrisani.");
DEFINE('_EW_DESC_STATS_URL_HITS', "Vsi URL naslovi, ki imajo manj zadetkov kot prejÅ¡nji dan bodo izbrisani.");
DEFINE('_EW_DESC_IGNORE_IP', "IzkljuÄ?i doloÄ?ene IP naslove iz statistike. LoÄ?ite jih z novo vrstico. Uporabljate lahko ti. wildcarde (npr. 192.* bo blokiral vse naslove, ki se zaÄ?nejo na 192.).");
DEFINE('_EW_DESC_UPDATE_TIME_VISITS', "OsveÅ¾evanje obiskovalcev v milisekundah, privzeto je 2000. Bodite pazljivi s to vrednostjo.");
DEFINE('_EW_DESC_UPDATE_TIME_STATS', "OsveÅ¡evanje statistike v milisekundah, privzeto je 4000. Bodite pazljivi s to vrednostjo.");
...
DEFINE('_EW_DESC_TRUNCATE_VISITS', "NajveÄ?je Å¡tevilo vidnih znakov v dolgih naslovih.");
DEFINE('_EW_DESC_TRUNCATE_STATS', "NajveÄ?je Å¡tevilo vidnih znakov v desnem menuju.");
DEFINE('_EW_DESC_STATS_KEEP_DAYS', "Koliko dni naj se obdrÅ¾i statistika v bazi, 0 = neskonÄ?no.");
DEFINE('_EW_DESC_TIMEZONE_OFFSET', "Ko ste v drugem Ä?asovnem pasu kot streÅ¾nik na katerem gostujete (pozitivne ali negativne vrednosti v urah).");
DEFINE('_EW_DESC_WEEK_OFFSET', "Tedenski odmik po formuli (3600*24*7) nam da Å¡tevilo tedno od 1.1.1970. Ta odmik je popravek, da se teden zaÄ?ne s ponedeljkom.");
DEFINE('_EW_DESC_DAY_OFFSET', "Dnevni odmik po formuli (3600*24) nam da Å¡tevilo dni od 1.1.1970. Ta odmik je popravek, da se dan zaÄ?ne ob 00:00. ");
DEFINE('_EW_DESC_FRONTEND_HIDE_LOGO', "Obkljukaj Ä?e Å¾eliÅ¡ prikazati 1x1px veliko ikono v izgledu.");
DEFINE('_EW_DESC_IP_STATS', "Obkljukaj, Ä?e Å¾eliÅ¡ omogoÄ?iti statistiko IP naslovov. V nekaterih drÅ¾avah je shranjevanje teh podatkov prepovedano z zakonom. Uporabljate na lastno odgovornost.");
DEFINE('_EW_DESC_HIDE_ADS', "Ta nastavitev skrije oglase v administraciji, Ä?e vas zelo nadlegujejo. ÄŒe jih obdrÅ¾ite pripomorete k nadaljnemu razvoju tega orodja. Hvala vam!");
DEFINE('_EW_DESC_TOOLTIP_ONCLICK', "Odkljukajte, Ä?e Å¾elite prikazati pomoÄ? na preletu z miÅ¡ko namesto s klikom.");
DEFINE('_EW_DESC_SERVER_URI_KEY', "Privzeta vrednost je 'REDIRECT_URL', kateri je standarden, Ä?e uporabljate prepisovanje URLja. Lahko nastavite na 'SCRIPT_URL'. Tako se bo beleÅ¾il samo index.php");
DEFINE('_EW_DESC_BLOCKING_MESSAGE', "SporoÄ?ilo, ki je prikazano blokiranim uporabnikom in nadaljne informacije zakaj ste jih blokirali.");
DEFINE('_EW_DESC_TOOLTIP_WIDTH', "ViÅ¡ina pomoÄ?i");
DEFINE('_EW_DESC_TOOLTIP_HEIGHT', "Å irina pomoÄ?i");
DEFINE('_EW_DESC_TOOLTIP_URL', "Tukaj lahko vpiÅ¡ete URL, ki bo predoÄ?il obiskovalÄ?ev IP naslov. {ip} bo zamenjan z obiskovalÄ?evim IP naslovom. Npr. http://www.example.com/query?iplookup={ip}");
DEFINE('_EW_DESC_IGNORE_URI', "Tukaj lahko vpiÅ¡ete URI, kateri se ne bo beleÅ¾il v statistiko. Wildcardi so dovoljeni.");
DEFINE('_EW_DESC_GOALS_NAME', "DoloÄ?i ime cilja. To ime bo vidno v statistiki.");
...
DEFINE('_EW_DESC_GOALS_GET_CONDITION', "Tukaj morate doloÄ?iti zadetek za vrednost iz prejÅ¡njega polja. (Primer uporabe: <b>p?t*r</b>) ");
DEFINE('_EW_DESC_GOALS_POST_VAR', "Precej podobno, ampak tukaj preverjamo vrednosti objavljene v formah. Ko imate formo na vaÅ¡i spletni strani, ki ima polje &lt;input type='text' name='<u>experiences</u>' /&gt;. (Primer uporabe: <b>exper*ces</b>)");
DEFINE('_EW_DESC_GOALS_POST_CONDITION', "Zadetek vrednosti iz spremenljivke POST. Npr. Å¾elimo preveriti ali ima uporabnik izkuÅ¡nje z javo.(Primer uporabe: <b>*java*</b>)");
...
DEFINE('_EW_DESC_GOALS_REDIRECT', "Uporabnik je preusmerjen na URL, ki ga vi doloÄ?ite. Ima viÅ¡jo prioriteto kot 'blokiranje'. (Primer uporabe:<b>http://www.codegravity.com/goaway.html</b>)");
...
DEFINE('_EW_DESC_FRONTEND_NO_BACKLINK', "Povezava do codegravity.com, ki jo lahko onemogoÄ?ite, ampak hvaleÅ¾ni vam bomo, Ä?e jo boste obdrÅ¾ali. Hvala vam.");
DEFINE('_EW_DESC_FRONTEND_COUNTRIES', "PrikaÅ¾e skupno statistiko drÅ¾av na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_COUNTRIES_FIRST', "ÄŒe Å¾eliÅ¡ zamenjati vrstni red Obiskovalcev/DrÅ¾av na prvi strani, odkljukaj. Nato se bodo obiskovalci pojavili na prvem mestu.");
DEFINE('_EW_DESC_FRONTEND_COUNTRIES_NUM', "Å tevilo prikazanih drÅ¾av na prvi strani");
DEFINE('_EW_DESC_FRONTEND_VISITORS', "Prikaz drÅ¾av na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_CACHE_FRONTEND_COUNTRIES', "ÄŒas v sekundah za shranjevanje skupnega Å¡tevila drÅ¾av na prvi strani.");
DEFINE('_EW_DESC_CACHE_FRONTEND_VISITORS', "ÄŒas v sekundah za shranjevanje obiskovalcev na prvi strani.");
DEFINE('_EW_DESC_FRONTEND_VISITORS_TODAY', "Prikaz danaÅ¡njih obiskovalcev na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_YESTERDAY', "Prikaz vÄ?erajÅ¡njih obiskovalcev na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_THIS_WEEK', "Prikaz obiskovalcev tekoÄ?ega tedna na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_LAST_WEEK', "Prikaz obiskovalcev prejÅ¡njega tedna na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_THIS_MONTH', "Prikaz obiskovalcev za tekoÄ?i mesec na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_LAST_MONTH', "Prikaz obiskovalcev za prejÅ¡nji mesec na prvi strani. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_FRONTEND_VISITORS_TOTAL', "Prikaz skupnega Å¡tevila obiskovalcev od namestitve ExtraWatch dalje. Spremembe bodo vidne po Ä?asu doloÄ?enem v CACHE_FRONTEND_");
DEFINE('_EW_DESC_LANGUAGE', "Kateri jezik bo uporabljen. Jezikovne datoteke so nameÅ¡Ä?ene v /components/com_extrawatch/lang/. ÄŒe Å¾elite ustvariti novo jezikovno datoteko, najprej preglejte domaÄ?o stran projekta in Ä?e jezika Å¡e ni tam, prekopirajte privzeto 'english.php' datoteko in jo preimenujte v npr. slovenian.php in jo prenesite v ta direktorij. Nato prevedite vse vrednosti na desni.");
DEFINE('_EW_DESC_GOALS', "Cilji vam omogoÄ?ajo doloÄ?anje posebnik parametrov. Ko so ti parametri doseÅ¾eni, se Å¡tevel ciljev poveÄ?a. Tako lahko nadzorujete ali je doloÄ?en uporabnik obiskal doloÄ?en URL, objavil doloÄ?eno vrednost, ima doloÄ?eno uporabniÅ¡ko ime ali prihaja iz doloÄ?enega naslova. Take uporabnike lahko tudi preusmerite na drug URL naslov.");
...
DEFINE('_EW_DESC_GOALS_BLOCK', "Nastavite to na 1, Ä?e Å¾elite, da bo obiskovalec blokiran. Blokirani ne bo videl ostale vsebine, samo sporoÄ?ilo, da je bil blokiran - brez prenaslavlanja in njegov IP naslov bo dodan v statistiko pod 'blokirani'");
