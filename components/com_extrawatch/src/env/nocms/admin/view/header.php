...
<head>
  <base href="http://stats.extrawatch.com/" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="author" content="Super User" />
  <meta name="generator" content="Joomla! - Open Source Content Management" />
  <title>Real-time live stats for Joomla, Wordpress, Drupal, Magento and PrestaShop</title>
  <link href="http://www.extrawatch.com/templates/extra_watch/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
  <script src="http://www.extrawatch.com/media/system/js/mootools-core.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/media/system/js/core.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/media/system/js/caption.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/media/system/js/mootools-more.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/templates/extra_watch/javascript/md_stylechanger.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/templates/extra_watch/javascript/hide.js" type="text/javascript"></script>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js" type="text/javascript"></script>
  <script src="http://www.extrawatch.com/modules/mod_testimonial_fader/tmpl/js/jquery.innerfade.js" type="text/javascript"></script>
  <script src="http://extrawatch.com/modules/mod_maximenuck/assets/moomaximenuck.js" type="text/javascript"></script>
  <script src="http://extrawatch.com/modules/mod_maximenuck/assets/fancymenuck.js" type="text/javascript"></script>
