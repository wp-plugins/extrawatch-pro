...
class ExtraWatchHeatmapHTML
{
  ...
  function __construct($database)
  {
    ...
    function renderHeatmapTable($day)
    {
        ...
        $output = sprintf("<table style='border: 1px solid black'><tr><th>%s</th><th>%s</th><th>%s</th><th>%s</th><th>%s</th><th>%s</th><th></th></tr>", _EW_HEATMAP_CLICKS, _EW_HEATMAP_TITLE, _EW_URI, _EW_EMAIL_REPORTS_1DAY_CHANGE, _EW_EMAIL_REPORTS_7DAY_CHANGE, _EW_EMAIL_REPORTS_28DAY_CHANGE);
