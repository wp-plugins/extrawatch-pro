                    ...
                    <tr>
                        ...
                        <td width="250px">
                            <a href='http://www.extrawatch.com' target='_blank'
                               style='font-family: verdana; font-size: 14px; align:top; font-weight: bold; color: black;'><?php echo _EW_ADMINHEADER_JW;?>&nbsp;<?php echo("2.2.1442");?>&nbsp;<?php echo("PRO");?></a><br/><?php echo _EW_TITLE;?>
                        </td>
                        <td>
