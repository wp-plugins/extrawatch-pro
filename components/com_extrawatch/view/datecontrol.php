...
<table width='100%'>
  <tr>
    ...
    <td align='right'><?php if ($next <= $today) echo("<a href='javascript:extrawatch_setDay($next)' id='$next'><img src='" . $extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/img/icons/calendar.gif' border='0' align='center' />" . ExtraWatchDate::getDateByDay($next) . "&gt;</a>"); ?></td>
  </tr>
</table>
