...
for($i=0;$i<EW_GRAPH_ITEMS_NUM;$i++) {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    if (@$chartar)
        ...
        {
            $fid = $cht1->did;  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            $filepathquery_tot = sprintf("SELECT COUNT(*) FROM #__extrawatch_dm_counter where did='%d' and ddate > '%s' and ddate <= '%s'", (int) $fid, $extraWatch->database->getEscaped($graphDayStartISOFormat), $extraWatch->database->getEscaped($graphDayEndISOFormat));  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
