...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="tablesorter">
    <thead>
    <tr>
        <th class="table" height="23" width="100%" align="left"><?php echo(_EW_DOWNLOADS_PATH);?></th>
        <th class="table" height="23" width="100%" align="left"><?php echo(_EW_DOWNLOADS_ALLOWED_REFERRER);?></th>
    ...
    if (@$filepathar)
        foreach($filepathar as $filepath)
        {
            ?>
        <tr>
            <td class="table" height="23" width="80%" align="left"><?php echo $filepath->dname;?></td>
            <td class="table" height="23" width="20%" align="left"><?php echo $filepath->allowedReferrer;?></td>
