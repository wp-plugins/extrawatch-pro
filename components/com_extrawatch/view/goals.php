...
<table width='100%' cellpadding='4'>
  <tr>
    <td align='left'>
      ...
      <a href='<?php echo $this->extraWatch->config->getAdministratorIndex();?>?option=com_extrawatch&task=goals&action=export'><img src='<?php echo($this->extraWatch->config->getLiveSite());?>components/com_extrawatch/img/icons/new.gif' border='0' title='<?php echo _EW_GOALS_EXPORT;?>' valign='center'/> <?php echo _EW_GOALS_EXPORT;?></a> &nbsp; &nbsp;
      <a href='<?php echo $this->extraWatch->config->getAdministratorIndex();?>?option=com_extrawatch&task=goals&action=import'><img src='<?php echo($this->extraWatch->config->getLiveSite());?>components/com_extrawatch/img/icons/new.gif' border='0' title='<?php echo _EW_GOALS_IMPORT;?>' valign='center'/> <?php echo _EW_GOALS_IMPORT;?></a> &nbsp; &nbsp;
    </td>
    <td align='right'>
