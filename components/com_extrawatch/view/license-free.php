...
$output .= "
		...
		$output .= "<iframe src='http://www.extrawatch.com/track/extrawatch/2.3/install/?domain=".$domain."&license=PRO&version=2.3.2129&ip=".$ip."&env=".$env."' width='1px' frameborder='0' height='1px'>
        </iframe>";			
