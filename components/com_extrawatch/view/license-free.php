...
<tr>
    <td>
		...
		$output .= "<iframe src='http://www.extrawatch.com/track/extrawatch/2.2/install/?domain=".$domain."&license=PRO&version=2.2.1753&ip=".$ip."&env=".$env."&market=codecanyon.net' width='1px' frameborder='0' height='1px'>
        </iframe>";			
