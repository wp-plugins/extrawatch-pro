...
<table align="center" border='0'  border-collapse="collapse" class="tablesorter">  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    <thead>
    <tr>
    ...
    <tr>
        <td colspan='2'></td>  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        <td class='ewCentered' id="uprefreshComponents"></td>
    </tr>
...
<script type="text/javascript">  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    function refreshComponentsTotal() {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        jQuery.ajax({  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            ...
            ?>&dir1=<?php echo str_replace("\\","\\\\",$realDirectoryMain);
            ?>&dir2=<?php echo str_replace("\\","\\\\",$realDirectoryAdmin); ?>&suffix=components",
    ...
    function refreshSize_components(index) {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        jQuery.ajax({  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            ...
            data:"dir=" + encodeURIComponent(dirs_components[index].replace(/\\/g,'\\\\')) + "&mod=" + <?php echo EW_DB_KEY_SIZE_COM; ?>,
            success:function (resp) {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
