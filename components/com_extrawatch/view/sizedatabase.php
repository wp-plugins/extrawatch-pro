...
<table align="left" border='0'  border-collapse="collapse" width="100%" class="tablesorter">  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    foreach ($rows0 as $row) {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        */
        ...
        $trendsIcon = "<img src='" . $extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/img/icons/trend_icon.gif' border='0'  " . $extraWatch->helper->getTooltipOnEvent() . "=\"ajax_showTooltip('" . $extraWatch->config->getLiveSiteWithSuffix() . $extraWatch->env->renderBackendAjaxLink($extraWatch->config, 'ajax','trendtooltip') . "&group=" . EW_DB_KEY_SIZE_DB . "&name=" . $row->Name . "&date=$day&env=".
